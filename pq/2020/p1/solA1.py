...
import math
# fix print and string formatting from g to s for string and fix print, and convert from radians to degrees for comfort
x = 1;print("sin(%s)=%s" % (x, math.sin(x * math.pi/180)))
