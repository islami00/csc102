...
# on first: # The "==" was changed to "=" for assignment,
# then a colon was added after the bracket to complete the declaration
# on the third: the return was indented and made to return the increment
# on the last: the function was called in print
